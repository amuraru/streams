...
public class RegressionTree 
	 ...
	 */
	public RegressionTree(Double delta, String linearRegressionClass, Map<String, String> parameters) throws Exception{
		//	  FIXME warning: removed by balke: because it's never used
		//	    this.linearRegressionClass = linearRegressionClass;
		//		this.parameters = parameters;
		this.tree = new RegressionTreeModel(linearRegressionClass, parameters);
