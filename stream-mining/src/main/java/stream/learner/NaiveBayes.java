...
extends AbstractClassifier<Data,String>
{
    ...
    public String predict( Data item ){
        ...
        if( log.isDebugEnabled() ) {
            log.debug( "labelAttribute is {}, data-item is: {}", labelAttribute, item );
            log.debug( "Predicting class {}, label is: {}, confidence-gap: " + confidence + " wop=" + wop, maxClass, item.get( labelAttribute ) );
        }
        return maxClass;
    }
