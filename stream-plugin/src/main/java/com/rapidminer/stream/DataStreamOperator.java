...
import com.rapidminer.stream.util.ParameterTypeDiscovery;
	...
	implements Measurable, DataProcessor
{
	...
	final InputPort input = getInputPorts().createPort( "data" );
	...
	public void doWork() throws OperatorException {
		...
		DataObject datum = input.getData( DataObject.class );
