...
public class StreamProcess extends OperatorChain {
	...
	final OutputPort dataStream = getSubprocess( 0 ).getInnerSources().createPort( "data stream" );
	final InputPort outputStream = getSubprocess( 0 ).getInnerSinks().createPort( "data stream" );
